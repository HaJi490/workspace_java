...
public class Test01_1_람다식설명 {
	//*
	public static MyInterface2 test3() {
		return new MyInterface2() {	//익명클래스, 익명객체 생성
			@Override
			public void print() {
	...
	public static void main(String[] args) {
		...
		m1.print();
		//함수형 스타일의 람다식 구현 
		MyInterface2 m2 = ()->System.out.println("m2::hello");//함수형 인터페이스 - 오직 한 메소드만 구현한다 
		m2.print();
		
		Multiply2 m3 = () -> 3.14 * 2;//getValue() 메소드를 overriding하는 코드 //객체를 m3가 가지고있고 추상메서드에서 실행

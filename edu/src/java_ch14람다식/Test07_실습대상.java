...
public class Test07_실습대상 {

	static String test(StringFunc sf, String s) { //test는 인터페이스의 객체,String을 받음
		return sf.modify(s);
	}
	...
	public static void main(String[] args) {
		...
		StringFunc sf1 = (s) -> {//comma를 blank로 바꾸는 modify() 본문 //sf1객체를 만듦, s로 받은건x
			String result = "";
			char c;
		...
		//람다식을 전달
		String s1 = test(sf1, str);//객체를 test함수(객체,문자열)에 보내

...
public class Test02_실습대상 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1, s3의 출력값 비교>>  " + s1 + " : "+ s3.toString());	//s1은 객체, s3는 toString을 호출
		System.out.println("s2,s4의 해시코드 비교>>  " +s2.hashCode()+":" + s4.hashCode());//s2, s4 : 같은 값 >>String Pool 영역의 같은 값을 사용
		...
		if (s1.equals(s3)) {//Object의 equal()를 overriding - hash code가 아닌 값으로 비교하도록 String class에서 재정의한 것 = String으로 비교
